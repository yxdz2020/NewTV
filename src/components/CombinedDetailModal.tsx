...
const CombinedDetailModal: React.FC<CombinedDetailModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-gray-800 bg-opacity-90 rounded-lg shadow-lg w-[90vw] max-w-4xl h-[75vh] md:h-[70vh] flex flex-col md:flex-row overflow-hidden relative">
        <button
          onClick={() => {
            // 清除倒计时定时器
            if (timerRef.current) {
        ...
        <div className="w-full md:w-2/3 relative z-10 h-full">
          ...
          <div className="absolute inset-0 p-3 md:p-8 pb-32 md:pb-40 overflow-y-auto">
            ...
            {isLoading && !doubanDetail && !videoDetail ? (
              <div className="flex flex-col items-center justify-center h-32 md:h-20">
